...
from utils_Synapse import test_single_volume
...
parser.add_argument('--output_dir', type=str, default='./model_out/Synapse', help='output dir')   
...
parser.add_argument('--test_save_dir', type=str, default='.model_out/Synapse/predictions', help='saving prediction as nii!')
...
if __name__ == "__main__":
    ...
    log_folder = './model_out/Synapse/test_log'
